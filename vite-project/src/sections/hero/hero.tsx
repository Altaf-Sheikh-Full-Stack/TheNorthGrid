...
import { userData1, userData2, userData3 } from "./userdata"
        ...
        <Section className="Hero" backgroundColor="LiteWhite" >
            <Box className="Hero-info" backgroundColor="Brand">
                <Box className="Hero-info-text" backgroundColor="Brand">
                    <Text size="small" color="black">200+ people already get hired this week</Text>
                ...
                <Box className="Hero-info-buttons" backgroundColor="Brand">
                    ...
                    <Text>Offer ends today</Text>
                </Box>
            </Box>
            <Box className="Hero-Content" backgroundColor="LiteWhite">
               <Box className="Hero-Content-Section" backgroundColor="LiteWhite" >
                    {userData1.map((data, index) => (
                        <Box className="Hero-Content-Section-Card" key={index}>
                            <img src={data.img} alt="" />
                            <Box className="Hero-Content-Section-Card-Info" backgroundColor="LiteWhite">
